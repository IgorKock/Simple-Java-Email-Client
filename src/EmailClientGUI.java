...
public class EmailClientGUI extends JFrame {
    ...
    public EmailClientGUI() {
        setTitle("Cliente de E-Mail Simples em Java para Gmail");
        setSize(800, 600);
    ...
    private void initUI() {
        ...
        JButton forwardButton = new JButton("Encaminhar");
        ...
        replyButton.addActionListener(e -> prepareEmailAction("Responder"));
        forwardButton.addActionListener(e -> prepareEmailAction("Encaminhar"));
        ...
        JButton composeButton = new JButton("Escrever");
        JButton refreshInboxButton = new JButton("Recarregar Caixa de Entrada");
    ...
    private void showLoginDialog() {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Falha em iniciar a sessão: " + e.getMessage(),
    ...
    private void refreshInbox() {
        try {
            ...
            for (Message message : messages) {
                emailListModel
                        .addElement(message.getSubject() + " - De: " + InternetAddress.toString(message.getFrom()));
            }
        } catch (MessagingException e) {
            JOptionPane.showMessageDialog(this, "Falha em carregar E-Mails: " + e.getMessage(), "Erro",
    ...
    private void emailListSelectionChanged(ListSelectionEvent e) {
        if (!e.getValueIsAdjusting() && emailList.getSelectedIndex() != -1) {
            try {
                ...
                emailContent.append("Assunto: " + selectedMessage.getSubject() + "\n\n");
                emailContent.append("De: " + InternetAddress.toString(selectedMessage.getFrom()) + "\n\n");
    ...
    private void prepareEmailAction(String actionType) {
        if (emailList.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(this, "Sem Email selecionado.", "Erro", JOptionPane.ERROR_MESSAGE);
            return;
        }
        try {
            Message selectedMessage = messages[emailList.getSelectedIndex()];
            String to = actionType.equals("Responder") ? InternetAddress.toString(selectedMessage.getFrom()) : "";
            String subjectPrefix = actionType.equals("Responder") ? "Re: " : "Fwd: ";
    ...
    private void showComposeDialog(String to, String subject, String body) {
        JDialog composeDialog = new JDialog(this, "Escrever Email", true);
        ...
        JButton attachButton = new JButton("Anexar Arquivos");
        ...
        JLabel attachedFilesLabel = new JLabel("Sem arquivos anexados");
